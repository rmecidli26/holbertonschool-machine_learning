#!/usr/bin/env python3
"""Defines a neural network with one hidden layer performing evaluation"""
import numpy as np
...
class NeuralNetwork:
    ...
    def evaluate(self, X, Y):
        ...
        Returns:
        prediction (numpy.ndarray): Predicted binary labels with shape (1, m).
        cost (float): The network's calculated cost.
        """
